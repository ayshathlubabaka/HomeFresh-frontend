...
function Login() {
  ...
  return (
    <>
      {loading ? ('Loading') : (
        <div className="flex h-screen " style={{ backgroundImage: 'url(https://img.freepik.com/free-photo/fresh-gourmet-meal-beef-taco-salad-plate-generated-by-ai_188544-13382.jpg?t=st=1709984887~exp=1709988487~hmac=2ea07669ac4913df1a4108cfcc1af010ef9eca9618e99a1eaea47ef06715e652&w=1480)', backgroundSize: 'cover' }}>
          ...
          <div className="w-full lg:w-1/2 flex items-center justify-center h-full  ">
            <div className="p-12 rounded-md w-full lg:w-6/12 border border-gray-300 shadow-2xl " style={{ backgroundColor: 'rgba(255, 255, 255, 0.4)' }}>
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-4 mt-10">
                  ...
                  <textarea id="username" value={username} onChange={e => setUsername(e.target.value)} placeholder="Username" style={{ resize: "none", backgroundColor: 'rgba(255, 255, 255, 0.7)' }} className="w-full p-2 rounded-lg bg-white "></textarea>
                </div>

                <div className="mb-4">
                  <label htmlFor="Password" className="block font-medium text-black" style={{ fontSize: "20px" }}>Password</label>
                  <textarea id="Password" placeholder="Password" value={password} onChange={e => setPassword(e.target.value)} style={{ resize: "none", backgroundColor: 'rgba(255, 255, 255, 0.7)' }} className="w-full p-2 rounded-lg bg-white "></textarea>
                  <div>
                ...
                <div className="flex justify-center items-center mt-9">
                  <button type="submit" className=" text-white px-8 py-2 font-medium rounded-md transform hover:scale-105 hover:shadow-xl transition-all duration-300" style={{ backgroundColor: '#4caf50' }}>
                    Submit
                  </button>
                </div>
